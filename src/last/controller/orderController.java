...
public class orderController {
    ...
    public void choice(ActionEvent event) throws Exception {
        ...
        FXMLLoader login = new FXMLLoader(getClass().getResource("/last/view/order/payment.fxml"));
        try {
    ...
    public void cancel(ActionEvent event) throws Exception {
        ...
        FXMLLoader login = new FXMLLoader(getClass().getResource("/last/view/main/foodin.fxml"));
        try {
            Parent root = login.load();
