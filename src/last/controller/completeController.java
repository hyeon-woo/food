...
public class completeController {
    ...
    public void goConfirm(ActionEvent event) throws Exception {
        ...
        FXMLLoader login = new FXMLLoader(getClass().getResource("/last/view/order/orderConfirm.fxml"));
        try {
    ...
    public void goLogout(ActionEvent event) throws Exception {
        ...
        if (result.get() == okbtn) {
            ...
            FXMLLoader login = new FXMLLoader(getClass().getResource("/last/view/main/foodout.fxml"));
            try {
                Parent root = login.load();
